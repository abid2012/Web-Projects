...
<body>
    <div class="row">
        <div class="col-lg-2 bg-dark text-white text-center" style="height: ;">
            ...
            <a href="./booking.php"><button class="my-btn1 active">Booking Database</button></a> <br> <br>
   ...
   <br />  
    ...
    <h3 align="center">Booking Table</h3><br />  
...
<h3>Edit Booking Id:</h3>

<form action="editbookingid.php" method="POST">
<table style="border-collapse: separate;border-spacing: 1em;">
<tr>
    <th>Old Id:</th>
...
<input type="submit" value="Edit" class="btn btn-primary"> -->
    ...
    $(document).ready(function(){  
     $('#editable_table').Tabledit({
      ...
      columns:{
       identifier:[0, "Id"],
       editable:[[1, 'Customer_Name'], [2, 'Customer_Email'], [3, 'Customer_Phone'], [4, 'Best_Time_To_Call'], [5, 'Service']]
      },
      restoreButton:false,
