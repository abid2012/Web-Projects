...
<body>
    <div class="row">
        <div class="col-lg-2 bg-dark text-white text-center" style="height: ;">
            ...
            <a href="./servicedb.php"><button class="my-btn1 active">Service Database</button></a> <br> <br>
   ...
   <br />  
    ...
    <h3 align="center">Service Table</h3><br />  
     ...
     <table class="table table-bordered table-striped">
        ...
        while($row = $result->fetch_assoc()) {
            ...
            <tr>
                <?php $id = $row['Id']; ?>
                <td><?php echo $id ?></td>
                <?php $title = $row['Service_Name']; ?>
                <td><?php echo $title ?></td>
                <?php $detail = $row['Service_Detail']; ?>
...
<form action="serviceaction.php" method="POST" class="mt-2" enctype="multipart/form-data">
