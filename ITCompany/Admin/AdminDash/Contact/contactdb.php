...
<body>
    <div class="row">
        <div class="col-lg-2 bg-dark text-white text-center" style="height: ;">
            ...
            <a href="./contactdb.php"><button class="my-btn1 active">Contact Database</button></a> <br> <br>
   ...
   <br />  
    ...
    <h3 align="center">Contact Table</h3><br />  
...
<form action="addcontact.php" method="POST" class="mt-2">
...
<form action="editcontactid.php" method="POST">
<table style="border-collapse: separate;border-spacing: 1em;">
<tr>
    <th>Old Id:</th>
...
<input type="submit" value="Edit" class="btn btn-primary"> -->
    ...
    $(document).ready(function(){  
     $('#editable_table').Tabledit({
      ...
      columns:{
       identifier:[0, "Id"],
       editable:[[1, 'Email'], [2, 'Phone'], [3, 'Address']]
      },
      restoreButton:false,
